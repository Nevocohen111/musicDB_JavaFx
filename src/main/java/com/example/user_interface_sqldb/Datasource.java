...
public class Datasource {
    ...
    public static final String DELETE_ARTIST_BY_ID = "DELETE FROM " + TABLE_ARTISTS + " WHERE " +
            COLUMN_ARTIST_ID + " = ?";
    ...
    public boolean deleteArtist(int artistId) {
        try {
            if(deleteArtist != null) {
                ...
                int rows = deleteArtist.executeUpdate();
                return rows > 0;
            }
            return false;
        } catch (SQLException e) {
